...
export const SAMPLE_CSV = `cliente,ciudad,region,comercial,segmento,F1,F2,F3,F4,F5,F6,F7,F8,F9,F10,volumen,nombre_F1,nombre_F2,nombre_F3,nombre_F4,nombre_F5,nombre_F6,nombre_F7,nombre_F8,nombre_F9,nombre_F10
García Distribuciones,Sevilla,Sur,Pepe García,Generalista,45,30,10,3,2,2,2,3,2,1,2000,Colas básicas,Enfoscados,Monocapas,Juntas,Impermeabilización,Autonivelantes,Reparación,Adhesivos técnicos,SATE,Acabados técnicos
